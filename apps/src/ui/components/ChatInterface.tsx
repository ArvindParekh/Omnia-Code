...
const mockMessages: Message[] = [
  {
    id: "1",
    role: "user", 
    content: "Can you help me review this React component and suggest improvements?",
    timestamp: Date.now() - 300000
  },
  {
    id: "2",
    role: "assistant",
    content: "I'd be happy to help you review your React component! Please share the component code and I'll analyze it for potential improvements in areas like performance, accessibility, maintainability, and best practices.\n\nYou can either:\n1. Paste the code directly in the chat\n2. Attach the file using the attachment button\n3. Let me read it directly from your project files",
    timestamp: Date.now() - 295000
  },
  {
    id: "3",
    role: "user",
    content: "Let me share the UserProfile component. It's in src/components/UserProfile.tsx",
    timestamp: Date.now() - 180000,
    attachments: [
      { type: "file", name: "UserProfile.tsx", size: 3420 }
    ]
  },
  {
    id: "4", 
    role: "assistant",
    content: "I'll analyze the UserProfile component for you. Let me read the file first and then provide a comprehensive review.",
        ...
        <div className={`flex flex-col ${isUser ? "items-end" : "items-start"}`}>
          ...
          <Card className={`p-4 ${
            ...
            <div className="prose prose-sm max-w-none">
              <div className={`whitespace-pre-wrap text-sm ${isUser ? "text-primary-foreground" : "text-foreground"}`}>
                {message.content}
...
export function ChatInterface({ session }: ChatInterfaceProps) {
  ...
  const [isSessionRunning, setIsSessionRunning] = useState(session.status === "running")
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      const assistantMessage: Message = {
        ...
        role: "assistant", 
        content: "I understand. Let me process your request and provide a detailed response.",
        timestamp: Date.now(),
        streaming: true
      }
      ...
      <div className="flex items-center justify-between border-b glass-morphism dark:glass-morphism-dark p-4">
        <div className="flex items-center space-x-3">
          <div className={`h-8 w-8 rounded-lg bg-gradient-to-br ${
            session.provider === "claude" ? "from-blue-500 to-purple-600" :
            session.provider === "gemini" ? "from-emerald-500 to-teal-600" :
      ...
      <div className="border-t glass-morphism dark:glass-morphism-dark p-4">
        <form onSubmit={handleSubmit} className="space-y-3">
          <div className="flex space-x-2">
            ...
            <div className="flex flex-col space-y-2">
              <Button 
                type="submit" 
                size="icon"
                disabled={!input.trim() || isLoading || !isSessionRunning}
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              <Button variant="ghost" size="icon" className="h-8 w-8" disabled={!isSessionRunning}>
