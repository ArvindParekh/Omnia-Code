    ...
    <div className="space-y-2 p-4">
            ...
            <div className="p-3">
              ...
              <div className="flex items-start justify-between mb-2">
                <div className="flex items-center space-x-2 min-w-0 flex-1">
                  <div className={`flex h-7 w-7 items-center justify-center rounded-md bg-gradient-to-br ${provider.color} shadow-sm flex-shrink-0`}>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-1">
                  <div className={`flex items-center justify-center h-5 w-5 rounded-full ${status.bg}`}>
      ...
      {sessions.length === 0 && (
        <div className="text-center py-8">
          ...
          <p className="text-xs text-muted-foreground mt-1">Create your first AI agent session</p>
        </div>
      )}
    </div>
  )
